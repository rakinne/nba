...
export declare enum CppReplicaMode {
}
export declare enum CppDurabilityMode {
}
export declare enum CppHttpType {
}
export declare enum CppHttpMethod {
}
export declare enum CppStoreOpType {
}
export declare enum CppServiceType {
}
export declare enum CppErrType {
}
export declare enum CppLogSeverity {
}
export declare enum CppSdCmdType {
}
export declare enum CppSdOpFlag {
}
export declare enum CppSdSpecFlag {
}
export declare enum CppConnType {
}
export declare enum CppViewQueryFlags {
}
export declare enum CppQueryFlags {
}
export declare enum CppSearchQueryFlags {
}
export declare enum CppAnalyticsQueryFlags {
}
export declare enum CppViewQueryRespFlags {
}
export declare enum CppQueryRespFlags {
}
export declare enum CppSearchQueryRespFlags {
}
export declare enum CppAnalyticsQueryRespFlags {
}
...
export interface CppConnection {
    ...
    shutdown(): void;
    selectBucket(bucketName: string, callback: (err: CppError | null) => void): void;
    get(scopeName: string, collectionName: string, key: CppBytes, transcoder: CppTranscoder, expiryTime: number | undefined, lockTime: number | undefined, parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, callback: (err: CppError | null, cas: CppCas, value: any) => void): void;
    exists(scopeName: string, collectionName: string, key: CppBytes, parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, callback: (err: CppError | null, cas: CppCas, exists: boolean) => void): void;
    getReplica(scopeName: string, collectionName: string, key: CppBytes, transcoder: CppTranscoder, mode: CppReplicaMode, parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, callback: (err: CppError | null, rflags: number, cas: CppCas, value: any) => void): void;
    store(scopeName: string, collectionName: string, key: CppBytes, transcoder: CppTranscoder, value: any, expirySecs: number | undefined, cas: CppCas | undefined, duraMode: CppDurabilityMode | undefined, persistTo: number | undefined, replicateTo: number | undefined, parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, opType: CppStoreOpType, callback: (err: CppError | null, cas: CppCas, token: CppMutationToken) => void): void;
    remove(scopeName: string, collectionName: string, key: CppBytes, cas: CppCas | undefined, duraMode: CppDurabilityMode | undefined, persistTo: number | undefined, replicateTo: number | undefined, parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, callback: (err: CppError | null, cas: CppCas) => void): void;
    touch(scopeName: string, collectionName: string, key: CppBytes, expirySecs: number, duraMode: CppDurabilityMode | undefined, persistTo: number | undefined, replicateTo: number | undefined, parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, callback: (err: CppError | null, cas: CppCas) => void): void;
    unlock(scopeName: string, collectionName: string, key: CppBytes, cas: CppCas, parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, callback: (err: CppError | null) => void): void;
    counter(scopeName: string, collectionName: string, key: CppBytes, delta: number | undefined, initial: number | undefined, expirySecs: number | undefined, duraMode: CppDurabilityMode | undefined, persistTo: number | undefined, replicateTo: number | undefined, parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, callback: (err: CppError | null, cas: CppCas, token: CppMutationToken, value: number) => void): void;
    lookupIn(scopeName: string, collectionName: string, key: CppBytes, flags: number, cmds: [
        optype: number,
        flags: number,
        path: string,
        ..._: any[]
    ], parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, callback: (err: CppError | null, res: any) => void): void;
    mutateIn(scopeName: string, collectionName: string, key: CppBytes, expirySecs: number | undefined, cas: CppCas | undefined, flags: number, cmds: [
        optype: number,
        flags: number,
        path: string,
        value: CppBytes,
        ..._: any[]
    ], duraMode: CppDurabilityMode | undefined, persistTo: number | undefined, replicateTo: number | undefined, parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, callback: (err: CppError | null, res: any) => void): void;
    viewQuery(designDoc: string, viewName: string, queryData: CppBytes, postData: CppBytes | undefined, flags: CppViewQueryFlags, parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, callback: (err: CppError | null, flags: CppViewQueryRespFlags, data: any, docId: string, key: string) => void): void;
    query(queryData: CppBytes, flags: CppQueryFlags, parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, callback: (err: CppError | null, flags: CppQueryRespFlags, data: any) => void): void;
    analyticsQuery(queryData: CppBytes, flags: CppAnalyticsQueryFlags, parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, callback: (err: CppError | null, flags: CppAnalyticsQueryRespFlags, data: any) => void): void;
    searchQuery(queryData: CppBytes, flags: CppSearchQueryFlags, parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, callback: (err: CppError | null, flags: CppSearchQueryRespFlags, data: any) => void): void;
    httpRequest(httpType: CppHttpType, httpMethod: CppHttpMethod, path: string, contentType: string | undefined, body: CppBytes | undefined, parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, callback: (err: CppError | null, flags: number, data: any) => void): void;
    ping(reportId: string | undefined, services: CppServiceType | undefined, parentSpan: CppRequestSpan | undefined, timeoutMs: number | undefined, callback: (err: CppError | null, data: string) => void): void;
    diag(reportId: string | undefined, callback: (err: CppError | null, data: string) => void): void;
}
export interface CppBinding {
    ...
    LCBX_RESP_F_NONFINAL: CppViewQueryRespFlags | CppQueryRespFlags | CppSearchQueryRespFlags | CppAnalyticsQueryRespFlags;
}
